...
// Validate ../../../app/admin/settings/settings/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/admin/settings/settings">> = Specific
  const handler = {} as typeof import("../../../app/admin/settings/settings/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
